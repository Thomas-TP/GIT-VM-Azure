import type { PresetCatalog, User, VmRequest, Status, AdminUser, Metrics, AuditEntry, Notification, Snapshot, CostData } from './types';
...
export const api = {
  ...
  adminCosts: () => req<CostData>('/api/admin/costs'),
